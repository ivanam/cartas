    ...
    <div class="container">
        ...
        <div class="row">
            <div class=" over col-md-6 portfolio-item">
                    ...
                    <img class="img-responsive" src="{{ URL::asset('static/img/invitacion.jpg') }}" alt="">
            ...
            <div class="col-md-6 portfolio-item">
                <a href="#">
                    <img class="img-responsive" src="{{ URL::asset('static/img/despido.jpg') }}" alt="">
                </a>
                <h3>
        ...
        <div class="row">
            <div class="col-md-6 portfolio-item">
                <a href="#">
                    <img class="img-responsive" src="{{ URL::asset('static/img/reclamo.jpg') }}" alt="">
            ...
            <div class="col-md-6 portfolio-item">
                <a href="#">
                    <img class="img-responsive" src="{{ URL::asset('static/img/reincorporacion.jpg') }}" alt="">
                </a>
                <h3>
